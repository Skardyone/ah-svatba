...
function Food() {
  return (
    <div className="h-[50vh] w-full px-6 md:w-3/4 xl:w-3/4 font-light text-base md:text-xl xl:text-xl flex flex-col items-center justify-center border-t-2 border-zelena pb-8">
      <p className="">
