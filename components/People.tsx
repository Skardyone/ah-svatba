...
function People() {
  return (
    <>
     <h3 className='uppercase text-xl xl:text-3xl font-bold pt-16'>Důležité osoby</h3>
    ...
    <div className='min-h-screen w-full xl:hidden flex flex-col lg:flex-row items-center justify-center py-8 space-y-5'>
        ...
        {people.map(item => (
            <div key={item.id} className='flex flex-col items-center justify-center font-bold'>
                <Image
            height={250}
            width={250}
            src={item.image}
